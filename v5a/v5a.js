...
var caratinVariation = {
    ...
    document.querySelector('.hero-content .font-mono').innerText = 'for under a $1 per day';
...
(function pollOnload() {
    if (document.querySelector('.hero-section  .container-lg')) {
        ...
        console.log(`%cShakil Ahmed Software Engineer v5a - ${new Date().toLocaleDateString()}`, styles);
        } catch (error) {
