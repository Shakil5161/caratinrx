...
var caratinVariation = {
    ...
    mainJs: function() {
    	var htmlContent = `<div class="ab-hero">
	        ...
	        <img src="https://moralstyle.com/wp-content/uploads/2022/06/shutterstock_1313687948-1-1.png" alt="" srcset=""></div>
	        </div>
    </div>`;
    ...
    document.querySelector('.ab-content .hero-text').innerText = 'Prescription medication for nail fungus that works';
...
(function pollOnload() {
    if (document.querySelector('.hero-section  .container-lg')) {
        ...
        console.log(`%cShakil Ahmed Software Engineer v19 - ${new Date().toLocaleDateString()}`, styles);
        } catch (error) {
