...
var caratinVariation = {
    ...
    mainJs: function() {
    	var htmlContent = `<div class="ab-hero">
	        ...
	        <div class='before-after'><p>Before Caratin</p><p>After Caratin</p>
	        <div class='diamond-img-left'>
		        <img src="https://moralstyle.com/wp-content/uploads/2022/06/Group-848.png" alt="" srcset="">
	        </div>
	        </div>
	        <div class='nail-img'>
	         <div class='diamond-img-right'><img src="https://moralstyle.com/wp-content/uploads/2022/06/Group-848.png" alt="" srcset=""></div>
	        <img src="https://moralstyle.com/wp-content/uploads/2022/06/Group-865.png" alt="" srcset=""></div>
	        </div>
    </div>`;
    ...
    document.querySelector('.hero-content .font-mono').innerText = 'for under $1 per day';

    document.querySelector('.hero-content .hero-text').innerText = 'Prescription medication for nail fungus that works'
...
(function pollOnload() {
    if (document.querySelector('.hero-section  .container-lg')) {
        ...
        console.log(`%cShakil Ahmed Software Engineer v5- ${new Date().toLocaleDateString()}`, styles);
        } catch (error) {
